...
class User(AbstractUser):
    personal_pic = models.ImageField(upload_to="Users_Personal_Pics", verbose_name="Personal Pic")
    ...
    device_identifier = models.CharField(max_length=500, verbose_name="Device Identifier")
